...
/* EXT_BLOCKLEN is the number of elements generated by the r2iq fft decimation flow.
// EXT_BLOCKLEN = ~(N (input num elements) / 2 + 1)) and needs to be multiples of 512 */
//   WINDOWS - USB TransferSize is 128K -> 64K (uint16) elements -> 512 * 64 
//   LINUX   - USB TransferSize is 138240 -> 69120 (uint16) elements -> 512 * 68
//			 - That said its been observed under linux the r2iq is generating 35840 -> 512*70  
#ifdef WIN32
	#define EXT_BLOCKLEN		512	* 64
#else
	#define EXT_BLOCKLEN		512	* 70
#endif
